"""Runtime configuration loading for SeekContext services."""
...
class RuntimeConfig:
    ...
    backend: str = "file"
    storage_path: str = ".seekcontext/store"
    uri_scheme: str = "seekcontext://"
    cold_backend: str | None = None
    cold_storage_path: str = ".seekcontext/cold"
...
def load_runtime_config(path: str | Path | None = None) -> RuntimeConfig:
    ...
    config = RuntimeConfig(
        ...
        storage_path=str(payload.get("storage_path", ".seekcontext/store")),
        uri_scheme=str(payload.get("uri_scheme", "seekcontext://")),
        cold_backend=payload.get("cold_backend"),
        cold_storage_path=str(payload.get("cold_storage_path", ".seekcontext/cold")),
