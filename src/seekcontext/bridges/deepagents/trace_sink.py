"""Deep Agents trace sink adapter backed by SeekContext."""
...
from seekcontext.bridges.base import AdapterCapability, AdapterSpec
from seekcontext.bridges.compat import DEEPAGENTS_AVAILABLE


@dataclass
class TraceSink:
    """Sink runtime events into SeekContext as raw trace ContextItems."""

    client: Any  # SeekContext
    scope: str

    @classmethod
    def spec(cls) -> AdapterSpec:
        return AdapterSpec(
            name="seekcontext.deepagents.trace_sink",
