...
class ScopeResolver:
    ...
    Example:
        ...
        # → "seekcontext://acme/bot/user_123/"
        resolver.ref_for("acme/bot/user_123", "item_abc")
        # → "seekcontext://acme/bot/user_123/item_abc"
    """

    def __init__(self, uri_scheme: str = "seekcontext://"):
    ...
    def prefix_for(self, scope: str) -> str:
        ...
        Returns:
            URI prefix ending with /, e.g. "seekcontext://acme/bot/user_123/"
        """
    ...
    def ref_for(self, scope: str, item_id: str) -> str:
        ...
        Returns:
            Full URI, e.g. "seekcontext://acme/bot/user_123/item_abc"
        """
