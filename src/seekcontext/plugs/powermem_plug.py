"""PowerMem DataPlug — imports PowerMem memory entries into SeekContext.
...
for SeekContext's evolution pipeline to process.
"""
...
class PowerMemPlug:
    ...
    def from_memory(
        ...
        **kwargs: Any,
        ...
        Pass the result to ``SeekContext.plug(plug, scope=...)``.
        """
