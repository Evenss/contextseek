"""ContextItem — the single unified object in SeekContext.

Every piece of data in SeekContext is a ContextItem. It is designed around
...
from seekcontext.domain.links import Link
from seekcontext.domain.provenance import Provenance
from seekcontext.domain.stages import STAGE_DEFAULT_STABILITY, Stability, Stage
...
@dataclass
class ContextItem:
    """The single core object in SeekContext.
