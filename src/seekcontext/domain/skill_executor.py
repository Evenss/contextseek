...
Skills are ContextItems with stage=skill. SeekContext's responsibility is
...
class SkillExecutor:
    ...
    SeekContext no longer executes skills — execution is handled by the
    ...
    def execute(self, skill: ContextItem, *, args: dict[str, Any] | None = None) -> dict[str, Any]:
        warnings.warn(
            "SkillExecutor.execute() is deprecated. SeekContext no longer executes skills. "
