...
from seekcontext._version import __version__ as PACKAGE_VERSION
from seekcontext.mcp.server import SeekContextMCPServer
from seekcontext.errors import SeekContextError
    ...
    def handle_request(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        if method == "initialize":
            ...
            result = {
                ...
                "serverInfo": {"name": "seekcontext-mcp", "version": PACKAGE_VERSION},
                "capabilities": {"tools": {}},
        ...
        if method == "tools/call":
            ...
            try:
                ...
                data = exc.as_dict() if isinstance(exc, SeekContextError) else None
...
def run_stdio_server() -> int:
    ...
    runtime = MCPRuntime(server=SeekContextMCPServer.with_default_client())
...
def create_sse_app(*, runtime: MCPRuntime | None = None) -> FastAPI:
    ...
    service = runtime or MCPRuntime(server=SeekContextMCPServer.with_default_client())
    app = FastAPI(title="SeekContext MCP SSE", version=PACKAGE_VERSION)
...
def run_sse_server() -> int:
    ...
    parser = argparse.ArgumentParser(prog="seekcontext-mcp-sse")
