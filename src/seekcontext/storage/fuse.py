"""Optional FUSE mount adapter for SeekContext (unified ContextItem API).

This module provides a virtual file system layer that exposes SeekContext
...
@dataclass
class SeekContextFUSEAdapter:
    """Read-only FUSE adapter exposing SeekContext items as files.
    ...
    Usage::
        ...
        adapter = SeekContextFUSEAdapter(client=client, scope="tenant/project/agent")
...
__all__ = ["SeekContextFUSEAdapter", "FUSE_AVAILABLE"]
