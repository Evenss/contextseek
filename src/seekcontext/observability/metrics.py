"""Prometheus-compatible metrics export for SeekContext."""
...
from seekcontext.observability.audit import MetricPoint
...
class MetricsCollector:
    ...
    def export_prometheus(self, *, prefix: str = "seekcontext") -> str:
